...
const LazySecurityTestingPage = React.lazy(() => import('./pages/SecurityTestingPage'));
const LazyHettyIntegrationPage = React.lazy(() => import('./pages/HettyIntegrationPage'));
...
function App() {
  ...
  const renderPage = React.useCallback(() => {
    ...
    const pageComponents = {
      ...
      security_testing: LazySecurityTestingPage,
      hetty_integration: LazyHettyIntegrationPage
    };
